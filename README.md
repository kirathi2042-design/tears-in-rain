...
| # | 模式 | 說明 |
|---|------|------|
| 01 | SMOKE 煙霧 | 上升煙柱中穿插清晰可見的渦旋（旋轉式 domain warp 直接刻出螺旋），重拍在落點旋起新渦 |
| 02 | FIRE 火焰 | 低音與重拍改變火焰高度、亮度、色溫與白熱核心 |
| 03 | RAIN 雨滴玻璃 | 從玻璃下方向上看雨滴撞擊玻璃，上表面開出透明水花、漣漪與 caustic 光環 |
| 04 | LAVA 熔岩燈 | Metaball 熔岩燈，bass 讓蠟球膨脹 |
| 05 | WARP 蟲洞航行 | 超空間隧道：航速隨音樂、星流線隨音量拉長、頻譜化作隧道口曼陀羅、重拍從核心射出光環 |
| 06 | ROAD 都市道路 | Blade Runner 風格的濕冷都市道路、末日科技天際線、霓虹反射與濃霧 |
| 07 | AURORA 極光 | Curl-noise 光簾在極夜山稜上舞動，頻譜決定每道光簾的高度 |
| 08 | ABYSS 深海生光 | 生物發光水母群與浮游粒子，重拍讓鐘形傘收縮脈動 |
| 09 | VINYL 黑膠迴轉 | 黑膠唱片宏觀視角：旋轉針槽、頻譜刻進蠟紋、燈帶反光與灰塵微粒 |
...
- WebGL2 / GLSL ES 3.0，單 pass、單三角形全螢幕 quad，九個場景都是程序化 noise/FBM/metaball，無任何貼圖資產
- `AnalyserNode`（FFT 2048）拆出 bass / mid / treble / level 四個包絡 + 能量比較式 beat detection，64-bin 頻譜以 R8 texture 餵進 shader
- 風場系統：重拍生成**獨立入流事件**；煙霧模式將事件化為可見渦旋（旋轉式 domain warp），火焰與熔岩則使用同一批事件作局部擾動。人聲中頻化為**漫遊微風**（`uBreeze`，方向緩慢漂移、空間上以 noise 調變成漣漪，絕不整面平移）
